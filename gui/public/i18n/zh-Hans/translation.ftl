...
firmware_update-status-ERROR_AUTHENTICATION_FAILED = 无法与追踪器完成认证
firmware_update-status-ERROR_NOT_ENOUGH_SPACE = 固件超出追踪器剩余 OTA 空间
