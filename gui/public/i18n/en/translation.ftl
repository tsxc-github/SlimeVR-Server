...
firmware_update-status-ERROR_NOT_ENOUGH_SPACE = Not enough space on the tracker for this firmware
...
firmware_update-devices-description-custom = Select the trackers you want to flash with your custom firmware.
...
firmware_update-custom_version = Custom Firmware
